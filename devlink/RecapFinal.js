...
import _styles from "./RecapFinal.module.css";
...
export function RecapFinal({ as: _Component = _Builtin.Block }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "recapsmallcontainer")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(
        ...
        >
          ...
          >
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "", "text14px", "italic")}
              tag="div"
            >
              ...
              {", et les "}
              <_Builtin.Span className={_utils.cx(_styles, "text-span-6")}>
