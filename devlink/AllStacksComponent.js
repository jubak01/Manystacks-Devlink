...
import _styles from "./AllStacksComponent.module.css";
...
export function AllStacksComponent({
  as: _Component = _Builtin.Block,
  title = "Votre collection de stacks",
}) {
        ...
        <_Builtin.Block className={_utils.cx(_styles, "stacksgrid")} tag="div">
          ...
          >
            ...
            >
              ...
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "stackimage")}
                  tag="div"
                >
                  <_Builtin.Block
                    className={_utils.cx(
