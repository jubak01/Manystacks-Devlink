...
import _styles from "./Co2.module.css";
    ...
    >
      <_Builtin.Block className={_utils.cx(_styles, "w_container")} tag="div">
        ...
        >
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "text14px", "unbounded", "green")}
            tag="div"
          >
            {"CO²e"}
          </_Builtin.Block>
      ...
      >
        <_Builtin.Block className={_utils.cx(_styles, "text14px")} tag="div">
          {"C’est "}
          <_Builtin.Span className={_utils.cx(_styles, "text-span-3")}>
            {"la réduction de l’empreinte carbone"}
          </_Builtin.Span>
          {" en passant par Manystacks"}
        </_Builtin.Block>
        <_Builtin.Block
          className={_utils.cx(
            _styles,
        ...
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "text14px", "medium", "purple")}
            tag="div"
          >
