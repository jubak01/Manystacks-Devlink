...
export function HeaderMarketPlace({
  ...
  return (
    ...
    >
      ...
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "container", "gap12px", "_44pxheight")}
          tag="div"
        >
          <_Builtin.Block
