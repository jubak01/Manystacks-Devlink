...
export function MenuBurgerContainer({ as: _Component = _Builtin.Block }) {
  ...
  return (
    ...
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "w_container", "alignright")}
        tag="div"
      >
        <_Builtin.Image
