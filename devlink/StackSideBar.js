...
import _styles from "./StackSideBar.module.css";
...
export function StackSideBar({
  ...
  title = "Bizdev de génie",
}) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component
      className={_utils.cx(_styles, "w_container", "vertical", "height100")}
      tag="div"
    >
      <_Builtin.Block
