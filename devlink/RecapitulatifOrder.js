...
import _styles from "./RecapitulatifOrder.module.css";
...
export function RecapitulatifOrder({ as: _Component = _Builtin.Block }) {
  ...
  return (
    ...
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "recap_container")}
        tag="div"
      >
        <_Builtin.Block
        ...
        <_Builtin.Block className={_utils.cx(_styles, "frame-142")} tag="div">
          <_Builtin.Block
            className={_utils.cx(
              _styles,
              "",
