...
import _styles from "./StepsComponent.module.css";
...
export function StepsComponent({ as: _Component = _Builtin.Block }) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component className={_utils.cx(_styles, "componentcontainer")} tag="div">
      <_Builtin.Block
        className={_utils.cx(_styles, "w_container", "_100", "justifycenter")}
        tag="div"
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "allstepcontainer", "hide")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "stepcontainer")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "circle", "green")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "text14px", "medium", "white")}
                tag="div"
              >
                {"1"}
              </_Builtin.Block>
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "text16px", "stepbar")}
              tag="div"
            >
              {"Entreprise"}
            </_Builtin.Block>
          ...
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "circle", "green", "actual")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "text14px", "medium", "white")}
          ...
          <_Builtin.Block
            ...
            tag="div"
          >
            <_Builtin.Block className={_utils.cx(_styles, "circle")} tag="div">
              <_Builtin.Block
                className={_utils.cx(_styles, "text14px", "medium", "white")}
                tag="div"
              >
          ...
          />
          <_Builtin.Block
            className={_utils.cx(_styles, "vectors-wrapper-copy")}
            tag="wrapper"
          />
        </_Builtin.Block>
        <_Builtin.Block
          className={_utils.cx(_styles, "allstepcontainer")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "stepcontainer")}
