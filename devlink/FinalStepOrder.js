...
import _styles from "./FinalStepOrder.module.css";
...
export function FinalStepOrder({ as: _Component = _Builtin.Block }) {
      ...
      >
        ...
        >
          <_Builtin.Block
            ...
            tag="div"
          >
            {"Le signataire est-il le représentant légal ?"}
          </_Builtin.Block>
          <_Builtin.Block
            className={_utils.cx(
              _styles,
        ...
        >
          ...
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "", "frame-167")}
              tag="div"
            >
              <_Builtin.Image
                ...
                height="auto"
                alt=""
                src="https://uploads-ssl.webflow.com/65474f5b3ac46dc4b33db7b7/6579d83c1b34b07a9544b00d_uncheck_grey_icon.svg"
              />
              <_Builtin.Block
                className={_utils.cx(
                  _styles,
              ...
              >
                <_Builtin.Block
                  ...
                  tag="div"
                >
                  {"Pièce d’identité du signataire (recto)"}
                </_Builtin.Block>
                <_Builtin.Image
                  className={_utils.cx(_styles, "image20x20px")}
                  loading="lazy"
                ...
                >
                  ...
                  >
                    {
                      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vel sem sit amet purus auctor imperdiet. Ut pulvinar velit scelerisque, sollicitudin tellus et, ultricies lacus. Maecenas facilisis auctor lacinia."
                    }
                  </_Builtin.Block>
                </_Builtin.Block>
              </_Builtin.Block>
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "frame-94")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "lightbutton")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "", "frame-164")}
                  tag="div"
                >
                  <_Builtin.Block
                    className={_utils.cx(
          ...
          >
            ...
            >
              <_Builtin.Image
                ...
                height="auto"
                alt=""
                src="https://uploads-ssl.webflow.com/65474f5b3ac46dc4b33db7b7/6579da913b466da17412d5ae_check_green_icon.svg"
              />
              <_Builtin.Block
                className={_utils.cx(
                  _styles,
            ...
            >
              ...
              >
                <_Builtin.Image
                  ...
                  height="auto"
                  alt=""
                  src="https://uploads-ssl.webflow.com/65474f5b3ac46dc4b33db7b7/6579db02389fa9aac727b450_trash_purple.svg"
                />
              </_Builtin.Block>
            </_Builtin.Block>
          </_Builtin.Block>
